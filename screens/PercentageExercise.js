...
class PercentageExercise extends React.Component {
    ...
    newProblem = () => {
        switch (this.props.route.params.difficulty) {
            case "Easy":
                let n_1 = Math.floor(Math.random() * (9 - 1) + 1) / 10; // percentage
                let n_2 = Math.floor(Math.random() * 100) + 1; // Number
                this.setState({
                    n_1: n_1,
                    n_2: n_2
                })
            ...
            case "Medium":
                n_1 = Math.floor(Math.random() * (99 - 1) + 1) / 100; // percentage
                n_2 = Math.floor(Math.random() * 100) + 1; // Number
                this.setState({
                    n_1: n_1,
                    n_2: n_2
                })
            ...
            case "Hard":
                n_1 = Math.floor(Math.random() * (99 - 1) + 1) / 100; // percentage
                n_2 = Math.floor(Math.random() * 1000) + 1; // Number
                this.setState({
                    n_1: n_1,
                    n_2: n_2
                })
...
export default PercentageExercise;
